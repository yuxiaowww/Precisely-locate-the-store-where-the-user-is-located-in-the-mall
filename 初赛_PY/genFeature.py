...
def runMakeLabel(train,train_feature,validate,validate_feature):
...
#        return label_train,feat_train,label_validate,feat_validate
...
#   predict = model_xgb(label_train,label_train)
   ...
   runMakeLabel(train,trainFeature,validate,validateFeature)
