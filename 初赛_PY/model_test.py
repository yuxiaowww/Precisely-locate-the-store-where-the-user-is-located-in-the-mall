...
def runMakeLabel(train,train_feature,test,test_feature):
    ...
    for item in malls:
        ...
        label_test,feat_test = makelabel(test[test['mall_id']==item],test_feature[test_feature['mall_id']==item])
...
#   runMakeLabel(train,trainFeature,test,testFeature)
